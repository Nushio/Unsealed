...
public class Chapter3_4 extends BattleScreen {
    ...
    public void show() {
        ...
        camera.position.set(1300, 1320, 0);
        camera.update();
    }
    ...
    public void checkScene(float delta){
        ...
        switch(act){
            ...
            case 2:
                ...
                break;
            case 3:
                dialog.setText("Lidia: Terrex really thrive in this area. There's too many of them!");
                dialog.setVisible(true);
                if(stateTime>4){
                    act=4;
                }
            ...
            case 5:
                ...
                break;
            case 6:
                dialog.setText("Lidia: If Terrex weren't so aggresive, they'd totally be cute pets!");
                dialog.setVisible(true);
                if(stateTime>3){
                    act=7;
                }
...
//                dialog.setVisible(true);
                ...
                break;
            case 10:
                game.setScreen(new Chapter3_5(game));
                break;
        }
    }
    @Override
