...
import net.k3rnel.unsealed.battle.enemies.SandSnake;
import net.k3rnel.unsealed.battle.enemies.SandTurtle;
...
public class Chapter2_2 extends BattleScreen {

    protected Button restartButton;

    public Chapter2_2(Unsealed game) {
        super(game,true, "RouteTwo");
    ...
    public void checkScene(float delta){
        ...
        switch(act){
            case -1:
                ...
                break;
            case 0:
                dialog.setText("Remember you can use your Spells with J and L");
                dialog.setVisible(true);
                if(stateTime>4){
                    act = 1;
                    stateTime = 0;
            ...
            case 1:
                ...
                hero.setMana(0);
                grid.spawnEnemies(new SandTurtle(getAtlas(),100,3,0),new SandTurtle(getAtlas(),80,4,2),new SandTurtle(getAtlas(),100,5,1));
                act = 2;
                break;
            case 2:
            ...
            case 3:
                ...
                dialog.setVisible(false);
                hero.setMana(0);
                grid.spawnEnemies(new SandSnake(getAtlas(),60,3,0),new SandSnake(getAtlas(),60,4,1),new SandSnake(getAtlas(),60,5,2));
                act = 4;
                break;
            case 4:
                if(BattleGrid.checkState()==BattleGrid.battleWon){
                ...
                break;
            case 5:
                dialog.setText("Lidia: Sand Snakes and Sand Turtles? Alteria sure is different from home.");
                dialog.setVisible(true);
                if(stateTime>4){
                    act=6;
                }
            ...
            case 6:
                ...
                dialog.setVisible(false);
                hero.setMana(0);
                grid.spawnEnemies(new SandSnake(getAtlas(),100,5,0),new SandTurtle(getAtlas(),120,5,2),new SandSnake(getAtlas(),100,3,1),new SandTurtle(getAtlas(),60,4,2));
                act = 7;
                break;
            case 7:
                if(BattleGrid.checkState()==BattleGrid.battleWon){
