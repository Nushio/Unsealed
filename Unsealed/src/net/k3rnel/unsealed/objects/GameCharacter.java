...
public class GameCharacter extends MapObject {
	...
	public GameCharacter(TextureAtlas spriteAtlas, int mapX, int mapY, String mapName) {
        ...
        animations.put(AnimationType.WALK_UP, new Animation(1.5f, new TextureRegion[]{ tmp[0][1], tmp[0][2], tmp[0][3], tmp[0][4], tmp[0][5], tmp[0][6], tmp[0][7] }));
        animations.put(AnimationType.WALK_LEFT, new Animation(1.5f, new TextureRegion[]{ tmp[1][1], tmp[1][2], tmp[1][3], tmp[1][4], tmp[1][5], tmp[1][6], tmp[1][7] }));
        animations.put(AnimationType.WALK_DOWN, new Animation(1.5f, new TextureRegion[]{ tmp[2][1], tmp[2][2], tmp[2][3], tmp[2][4], tmp[2][5], tmp[2][6], tmp[2][7] }));
        animations.put(AnimationType.WALK_RIGHT, new Animation(1.5f, new TextureRegion[]{ tmp[3][1], tmp[3][2], tmp[3][3], tmp[3][4], tmp[3][5], tmp[3][6], tmp[3][7] }));
	}
