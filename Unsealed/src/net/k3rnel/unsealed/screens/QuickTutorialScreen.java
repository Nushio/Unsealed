 ...
 */
public class QuickTutorialScreen extends AbstractScreen {
    private Image splashImage;

    public QuickTutorialScreen( Unsealed game ) {
        super( game );
    }
    ...
    public void show() {
        ...
        SequenceAction actions = sequence(fadeIn(0.75f), delay(3f), fadeOut(0.75f),
